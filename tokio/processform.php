...
<head>
    ...
    <meta http-equiv="refresh" content="2;url=https://sc.npru.ac.th/tokio/inputform.php">
    <title>Add Training Message</title>
    <!-- Bootstrap CSS -->
...
try {
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        $assistantContent = isset($_POST['assistant_content']) ? $_POST['assistant_content'] : '';
        $systemContent = isset($_POST['system_content']) ? $_POST['system_content'] : '';

        // โค้ดสำหรับเพิ่มข้อมูลลงในฐานข้อมูล
        $stmt = $pdo->prepare("INSERT INTO messages (assistant_content, system_content) VALUES (:assistantContent, :systemContent)");
