...
try {
    ...
    if ($_SERVER["REQUEST_METHOD"] == "GET" && isset($_GET['id'])) {
        ...
        //echo "<p>Message with ID " . htmlspecialchars($id) . " has been deleted.</p>";
        echo "<div class=\"vertical-center text-center\">";
        echo "<div class=\"alert-custom\">";
        echo "<strong>Success! </strong> Message with ID " . htmlspecialchars($id) . " has been deleted.";
        echo "</div>";
        echo "</div>";
    } else {
        throw new Exception("ID not provided for deletion.");
    }
